                                    ...
                                    async function insertFile(file, res) {
                                        ...
                                        const mailOptions = {
                                            ...
                                            html: `<div style="text-align: center">
                                                <p>Your submitted details has been rejected. Please, verify it once or contact your class advisor.</p>
                                                <button style="padding:10px 20px;background:#4f37b9;border-radius: 20px;border:1px solid #4f37b9"><a style="text-decoration: none; color: white" href="">Home</a></button></div>`
                                        };
